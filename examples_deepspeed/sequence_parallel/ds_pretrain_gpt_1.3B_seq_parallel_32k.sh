...
data_path="/eagle/datascience/eku/Megatron-DeepSpeed_ViT/examples_deepspeed/sequence_parallel/BookCorpusDataset_text_document" ## Replace with string dataset of your choice. 
